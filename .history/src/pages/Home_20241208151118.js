  ...
  return (
    <div>
      ...
      <div className="info-section">
        ...
        <p className="paragraph">
        Most of the lore and their adaptations are written from the perspective of humans (for obvious reasons), the universe is divided into the Imperium of Man (the Human Factions), the Chaos (A faction of demons and gods), and the Zenos (Every non-human other than chaos).
        </p>
      </div>
    </div>
  );
